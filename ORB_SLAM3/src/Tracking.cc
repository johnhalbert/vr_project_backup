...
void Tracking::newParameterLoader(Settings *settings) {
    ...
    mpORBextractorLeft = new TPUFeatureExtractor("/home/ubuntu/user_custom_superpoint/assets/superpoint_edgetpu_fixed_v8_compiled_edgetpu/superpoint_edgetpu_fixed_v8_edgetpu.tflite", "", nFeatures,fScaleFactor,nLevels);

    if(mSensor==System::STEREO || mSensor==System::IMU_STEREO)
        mpORBextractorRight = new TPUFeatureExtractor("/home/ubuntu/user_custom_superpoint/assets/superpoint_edgetpu_fixed_v8_compiled_edgetpu/superpoint_edgetpu_fixed_v8_edgetpu.tflite", "", nFeatures,fScaleFactor,nLevels);

    if(mSensor==System::MONOCULAR || mSensor==System::IMU_MONOCULAR)
        mpIniORBextractor = new TPUFeatureExtractor("/home/ubuntu/user_custom_superpoint/assets/superpoint_edgetpu_fixed_v8_compiled_edgetpu/superpoint_edgetpu_fixed_v8_edgetpu.tflite", "", 5*nFeatures,fScaleFactor,nLevels);
